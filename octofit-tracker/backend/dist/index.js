...
app.post('/api/teams/', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Team creation failed', error: error.message });
    }
});
...
app.post('/api/activities/', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Activity creation failed', error: error.message });
    }
});
...
app.post('/api/leaderboard/', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Leaderboard entry creation failed', error: error.message });
    }
});
...
app.post('/api/workouts/', async (req, res) => {
    try {
        ...
        res.status(400).json({ message: 'Workout creation failed', error: error.message });
    }
});
